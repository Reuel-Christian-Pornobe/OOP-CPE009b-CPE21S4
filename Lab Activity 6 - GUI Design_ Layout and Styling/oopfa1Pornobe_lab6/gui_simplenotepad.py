import sys
from PyQt5.QtWidgets import QWidget, QApplication, QGridLayout, QLabel, QLineEdit, QMainWindow, QPushButton, QAction, QFontDialog, \
                            QFileDialog, QTextEdit, QVBoxLayout, QBoxLayout, QGroupBox, QHBoxLayout
